...
@section('content')
	...
	<div class="content-header">
		...
		<div class="d-flex align-items-center"> {{-- Wrap right-side icons for alignment --}}
			...
			<a href="#" class="text-secondary me-3" title="Toggle Theme" id="themeToggleButton" aria-label="Toggle Theme"><i class="bi bi-brightness-high-fill fs-5 icon-color"></i></a> {{-- Added me-3 for spacing & icon-color --}}
			...
			@else
				...
				<div class="dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-end text-small shadow" aria-labelledby="dropdownUser">
						<li><a class="dropdown-item" href="{{ route('profile.edit') }}">Profile</a></li> {{-- Added Profile Link --}}
						<li><hr class="dropdown-divider"></li> {{-- Added Divider --}}
						<li>
