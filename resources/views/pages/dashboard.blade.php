...
@section('content')
	{{-- MODIFIED: Replaced header with a DaisyUI navbar component for a consistent layout --}}
	...
	{{-- MODIFIED: Main content area rewritten with Tailwind and DaisyUI classes --}}
	<div class="bg-base-100 rounded-box shadow-sm flex-grow flex flex-col justify-center items-center p-4">
